# KEYBOARD PROBLEM
# Each day, to enter their building, employees of an e-commerce company have to type a string of numbers into a console using a 3 x 3 numeric pad. Every day the numbers on the keypad are mixed up.
# Use the following rules to calculate the total amount of times it takes to type a string:
# It take 0 seconds to move their finger to the first key, and it takes 0 seconds to press the key where their finger is located any number of times.
# They can move their finger from one location to any adjacent key in 1 second, adjacent keys include those on a diagonal.
